...
public class ViewPatients extends javax.swing.JFrame {
  ...
  private void showPatientData(){
        try{
            ArrayList<PatientPojo> PatientList=PatientDao.getAllPatientDetail();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "P ID", "F_NAME", "S_NAME", "AGE", "OPD", "GENDER", "M_STATUS", "P_DATE", "ADDRESS", "CITY", "PHONE_NO", "DOCTOR_ID", "WARD_NO", "BED_NO", "Active"
            }
        ));
